...
const String URI = "https://c3f8d3b1.ngrok.io/";

class AdharaSocketDemo extends StatefulWidget {
  @override
  _AdharaSocketDemoState createState() => _AdharaSocketDemoState();
}

class _AdharaSocketDemoState extends State<AdharaSocketDemo> {
  ...
  sendMessageWithACK(identifier) {
    ...
    sockets[identifier].emitWithAck("chat_message", msg).then((data) {
      ...
      child: ListView(
        ...
        children: <Widget>[
          ...
          Container(
            margin: EdgeInsets.symmetric(horizontal: 8.0),
            child: RaisedButton(
              child: Text("Send TextBox Message"),
